            ...
            <div class="mod-config">
                <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
                    ...
                    <el-form-item>
                        ...
                        <el-button v-if="isAuth('product:attrgroup:save')" type="primary" @click="addOrUpdateHandle()">
                            新增</el-button>
...
export default {
    ...
    methods: {
        ...
        treenodeclick(data, node, component){
            console.log("attrgroup got click from category component", data, node, component);
            console.log("previous menu clicked id: ",data.catId)
            if(node.level == 3) {
