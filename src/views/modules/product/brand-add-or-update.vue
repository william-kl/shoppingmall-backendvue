  ...
  <el-dialog :title="!dataForm.brandId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="品牌logo地址" prop="logo">
        ...
        <singleUploaderVue v-model="dataForm.logo"></singleUploaderVue>
...
import singleUploaderVue from "../../../components/upload/singleUploader.vue"
import singleUploadVue from "../../../components/upload/singleUpload.vue"
export default {
  components: { singleUploaderVue, singleUploadVue },
  data() {
    return {
      visible: false,
      dataForm: {
