  ...
  <el-dialog :title="!dataForm.attrGroupId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible" @closed="dialogClose">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="所属分类id" prop="catelogId">
        ...
        <el-cascader filterable placeholder="try to search: iphone" v-model="dataForm.catelogPath" :options="categories" :props="props"></el-cascader>
      </el-form-item>
    </el-form>
        ...
        if (valid) {
          this.$http({
            ...
            data: this.$http.adornData({
              ...
              'catelogId': this.dataForm.catelogPath[this.dataForm.catelogPath.length - 1] //get the last one from catelogPath
            })
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
